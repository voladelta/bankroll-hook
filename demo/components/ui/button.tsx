...
const buttonVariants = cva(
  [
    ...
    "transition-colors duration-100 ease-[cubic-bezier(0.32,0.72,0,1)]",
    ...
    const internals = (
      <>
        <span
          aria-hidden
          className={cn(
            "absolute inset-0 rounded-[inherit] transition-[background-color,transform] duration-100 ease-[cubic-bezier(0.32,0.72,0,1)] group-active:scale-[0.98]",
            bgClass
          )}
        />
        <span className="relative inline-flex items-center justify-center gap-[inherit]">
          {loading ? (
            ...
            <span className="[&_svg]:stroke-[1.5] [&_svg]:transition-[stroke-width] [&_svg]:duration-100 [&_svg]:ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:[&_svg]:stroke-[2]">
              {label}
            </span>
          ) : (
            <>
              {LeadingIcon && (
                <LeadingIcon
                  size={iconSize}
                  strokeWidth={1.5}
                  className="transition-[stroke-width] duration-100 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:stroke-[2]"
                />
              )}
